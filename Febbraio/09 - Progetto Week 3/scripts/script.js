...
const deleteOne = (str, removeFirst) => {
    return removeFirst ? str.substring(1) : str.slice(0, -1);
}
...
console.log(isThisAnEmail('riccardodelpiccolo1@gmail.com'));
...
const whatDayIsIt = () => {
    ...
    return console.log(days[now.getDay()]);
}
...
console.log(howManyDays('2023-02-09'));
...
const isTodayMyBirthday = (birthdayMonth, birthdayDay) => {
    const today = new Date();

    return today.getDate() === birthdayDay && today.getMonth() + 1 === birthdayMonth;
}

console.log(isTodayMyBirthday(11, 28));
console.log(isTodayMyBirthday(2, 9));
...
console.log(deleteProp({name: 'Riccardo', age: 25}, 'age'));
...
const sumAllTheYears = (movies) => {
    return movies.reduce((sum, movie) => sum + parseInt(movie.Year, 10), 0);
}
...
console.log('CONTINUA NEL FILE SCRIPT.JS (ESERCIZI 20-26)');
...
const logTextFromTd = () => {
    document.querySelectorAll('td').forEach(td => console.log(td.innerText));
}
...
console.log('EXTRA - ESERCIZIO 27');
...
console.log('EXTRA - ESERCIZIO 28');
...
console.log('EXTRA - ESERCIZIO 29');
