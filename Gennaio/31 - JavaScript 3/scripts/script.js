...
console.log("charactersNames' length before: " + charactersNames.length);
console.log(charactersNames);
...
console.log("charactersNames' length after: " + charactersNames.length);
console.log(charactersNames); */
...
console.log("Selected character: " + randomCharacter.name);
console.log("Character height: " + randomCharacter.height) + " cm";
console.log("Character mass: " + randomCharacter.mass);
console.log("Character hair color: " + randomCharacter.hair_color);
console.log("Character skin color: " + randomCharacter.skin_color);
console.log("Character eye color: " + randomCharacter.eye_color);
console.log("Character birth year: " + randomCharacter.birth_year);
console.log("Character gender: " + randomCharacter.gender); */